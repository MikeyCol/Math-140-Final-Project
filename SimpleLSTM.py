...
def main():
    ...
    X['SOL/USDT'] = coins['SOL/USDT']['open'].values
    X['COMP/USDT'] = coins['COMP/USDT']['open'].values
    ...
    plt.plot(dataY_plot, label='True COMP Price')  # actual plot
    plt.plot(data_predict, label='Predicted COMP Price')  # predicted plot
